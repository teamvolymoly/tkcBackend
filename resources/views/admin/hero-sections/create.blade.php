...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="mt-2 text-3xl font-semibold tracking-tight">Create hero section</h1>
        </div>
    ...
    <form method="POST" action="{{ route('admin.hero-sections.store') }}" enctype="multipart/form-data" data-loading-form class="space-y-6">
        @csrf
        @include('admin.hero-sections._form')
        <div class="flex justify-end">
            <button type="submit" class="rounded-2xl bg-slate-900 px-5 py-3 text-sm font-semibold text-white">Save Hero Section</button>
        </div>
    </form>
</div>
@endsection
