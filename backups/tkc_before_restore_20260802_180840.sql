...
CREATE TABLE `reviews` (
  ...
  KEY `reviews_variant_id_foreign` (`variant_id`),
  ...
  CONSTRAINT `reviews_variant_id_foreign` FOREIGN KEY (`variant_id`) REFERENCES `product_variants` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sessions` VALUES ('rleVZQavIV9ZjqhwfJ094oFfPMU9AdR9qLBUqqci',NULL,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36','',1785674028);
...
-- Dump completed on 2026-08-02 18:08:43
