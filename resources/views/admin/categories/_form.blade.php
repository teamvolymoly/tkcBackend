            ...
            <div class="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
                <div class="grid gap-5 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name" value="{{ old('name', $category['name'] ?? '') }}" class="w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100 dark:border-slate-700 dark:bg-slate-950 dark:focus:ring-sky-500/10" placeholder="Green Tea" required>
                    </div>

                    <div>
                        <label class="mb-2 block text-sm font-medium text-slate-700 dark:text-slate-200">Category type</label>
                        <select name="parent_id" class="w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100 dark:border-slate-700 dark:bg-slate-950 dark:focus:ring-sky-500/10">
                    ...
                    <div>
                        ...
                        <div class="flex h-[116px] items-center justify-center overflow-hidden rounded-lg border border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-slate-950/60">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description" rows="6" class="w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100 dark:border-slate-700 dark:bg-slate-950 dark:focus:ring-sky-500/10" placeholder="Write a short note about this category...">{{ old('description', $category['description'] ?? '') }}</textarea>
                    </div>
                </div>

                <div class="rounded-sm border border-slate-200 bg-slate-50/70 p-5 dark:border-slate-800 dark:bg-slate-950/60">
                    <div>
                    ...
                    <div class="mt-5 space-y-4">
                        <label class="block">
                            ...
                            <input type="file" name="image" accept="image/*" class="w-full rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm outline-none transition focus:border-sky-400 focus:ring-4 focus:ring-sky-100 dark:border-slate-700 dark:bg-slate-950 dark:focus:ring-sky-500/10">
                        </label>
