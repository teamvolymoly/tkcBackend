...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.orders.index') }}" class="rounded-lg border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800">Back</a>
    </div>
        ...
        <div class="space-y-6">
            ...
            <section class="rounded-lg border border-white/70 bg-white/80 p-6 shadow-lg shadow-slate-200/40 dark:border-slate-800 dark:bg-slate-900/80 dark:shadow-none">
                ...
                <div class="mt-5 space-y-3 text-sm">
                    ...
                    <div class="flex items-center justify-between rounded-lg bg-slate-900 px-4 py-3 text-white dark:bg-white dark:text-slate-900"><span>Total</span><span class="font-semibold">Rs. {{ number_format((float) $order['total_amount'], 2) }}</span></div>
                </div>
            </section>
        </div>
        <div class="space-y-6">
            ...
            <section class="rounded-lg border border-white/70 bg-white/80 p-6 shadow-lg shadow-slate-200/40 dark:border-slate-800 dark:bg-slate-900/80 dark:shadow-none">
                ...
                @if (!empty($order['address']))
                    <div class="mt-5 rounded-lg bg-slate-50 p-5 text-sm text-slate-600 dark:bg-slate-950/60 dark:text-slate-300">
