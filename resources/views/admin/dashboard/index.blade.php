    ...
    <section class="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        @foreach ($summaryCards as $card)
            <div class="rounded-[8px] bg-white p-3 shadow-sm">
                <p class="text-[16px] text-black/70">{{ $card['label'] }}</p>
                <div class="mt-4 flex items-end justify-between gap-3">
                    <div>
                        <p class="text-[14px] font-semibold leading-none text-[#2b322c] md:text-[26px]">
    ...
    <section class="grid flex-1 gap-3 xl:grid-cols-[1.08fr_0.92fr]">
        <div class="rounded-[8px] bg-white p-3 shadow-sm">
            <div class="flex items-center justify-between">
                <h2 class="text-[18px] font-medium text-[#556053]">New Orders</h2>
            </div>
            <div class="mt-2 overflow-hidden rounded-full bg-[#f1f2ef] p-4">
                <div class="flex h-4 items-center justify-center rounded-full text-[16px] text-[#6f766f]">
                    No active orders
                </div>
            </div>
        ...
        <div class="rounded-[8px] bg-white p-3 shadow-sm">
            <div class="flex items-center justify-between">
                <h2 class="text-[18px] font-medium text-[#556053]">Stock Overview</h2>
            </div>
            <div class="mt-3 rounded-full bg-[#f1f2ef] p-4">
                <div class="flex h-4 items-center justify-center rounded-full text-[16px] text-[#6f766f]">
                    Low Stock Alerts
                </div>
            </div>
