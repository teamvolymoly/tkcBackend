...
<div class="space-y-6">
    ...
    <form method="POST" action="{{ route('admin.coupons.update', $coupon['id']) }}" class="space-y-6" data-loading-form>
        ...
        <div class="flex justify-end">
            <button type="submit" class="rounded-lg bg-slate-900 px-5 py-3 text-sm font-semibold text-white transition hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100">Save Changes</button>
        </div>
    </form>
</div>
@endsection
