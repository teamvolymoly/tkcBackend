...
<div class="space-y-6">
    <div>
        <h1 class="text-3xl font-semibold tracking-tight">Carts</h1>
    </div>
                ...
                <tbody class="divide-y divide-slate-200 bg-white dark:divide-slate-800 dark:bg-slate-900">
                    @foreach ($carts['data'] as $cart)
                        <tr>
                            ...
                            <td class="px-4 py-4 text-right"><a href="{{ route('admin.carts.show', $cart['id']) }}" class="rounded-lg border border-slate-200 px-3 py-2 text-xs font-semibold dark:border-slate-700">Inspect</a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
